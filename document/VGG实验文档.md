...
# 73.88裁剪83% 
python graf_prune_finetune_cifar_n.py --pretrained_dataset cifar100 --finetune_dataset cifar100 --finetune_data_dir ./data --pretrained_arch vgg_16_bn --finetune_arch vgg_16_bn \
--result_dir ./result/normal_pruned/73.88_cifar100tocifar100_vgg_16_pruned_83 \
--ci_dir ./calculated_ci/73.88_vgg_16_bn_cifar100 --batch_size 128 \
--epochs 300 --lr_type cos --learning_rate 0.05 --momentum 0.9 --weight_decay 0.0005 \
--graf --pretrain_dir ./pretrained_models/73.88_vgg_16_bn_cifar100.pth.tar --sparsity [0.30]*7+[0.75]*5
```
...
--graf --pretrain_dir ./pretrained_models/35.02_epoch650_selfsupcon_supcon_adapter_vgg_16_bn_cifar100.pth.tar --sparsity [0.30]*7+[0.75]*4+[0.755]
```
...
# selfsupcon adapter_vgg_16_bn 裁剪87，lr = 0.05
python graf_prune_finetune_cifar_n.py --pretrained_dataset cifar100 --finetune_dataset cifar100 --finetune_data_dir ./data --pretrained_arch adapter_vgg_16_bn --finetune_arch adapter_vgg_16_bn \
--result_dir ./result/normal_pruned/35.02_epoch650_selfsupcon_supcon_adapter_adapter_vgg_16_bn_cifar100tocifar100_pruned_87 \
--ci_dir ./calculated_ci/35.02_selfsupcon_supcon_adapter_vgg_16_bn_cifar100 --batch_size 128 \
--epochs 300 --lr_type cos --learning_rate 0.1 --momentum 0.9 --weight_decay 0.0005 \
--graf --pretrain_dir ./pretrained_models/35.02_epoch650_selfsupcon_supcon_adapter_vgg_16_bn_cifar100.pth.tar --sparsity [0.45]*7+[0.78]*5
```
...
--ci_dir ./calculated_ci/93.96_vgg_16_bn_cifar10 --batch_size 128 \
--epochs 300 --lr_type cos --learning_rate 0.05 --momentum 0.9 --weight_decay 0.0005 \
--pretrain_dir ./pretrained_models/93.96_vgg_16_bn_cifar10.pth.tar --sparsity [0.30]*7+[0.75]*5
```
...
```python
python graf_prune_finetune_cifar_n.py --pretrained_dataset cifar10 --finetune_dataset cifar100 --finetune_data_dir ./data --pretrained_arch adapter_vgg_16_bn --finetune_arch adapter_vgg_16_bn \
--result_dir ./result/graf_pruned/93.99_cifar10tocifar100_adapter_vgg_16_bn_pruned_81 \
--ci_dir ./calculated_ci/93.99_adapter_vgg_16_bn_cifar10 --batch_size 128 \
--epochs 300 --lr_type cos --learning_rate 0.1 --momentum 0.9 --weight_decay 0.0005 \
--pretrain_dir ./pretrained_models/93.99_adapter_vgg_16_bn_cifar10.pth.tar --sparsity [0.30]*7+[0.75]*5

nohup python graf_prune_finetune_cifar_n.py --pretrained_dataset cifar10 --finetune_dataset cifar100 --finetune_data_dir ./data --pretrained_arch adapter_vgg_16_bn --finetune_arch adapter_vgg_16_bn \
--result_dir ./result/graf_pruned/93.99_cifar10tocifar100_adapter_vgg_16_bn_pruned_81 \
--ci_dir ./calculated_ci/93.99_adapter_vgg_16_bn_cifar10 --batch_size 128 \
--epochs 300 --lr_type cos --learning_rate 0.1 --momentum 0.9 --weight_decay 0.0005 \
--pretrain_dir ./pretrained_models/93.99_adapter_vgg_16_bn_cifar10.pth.tar --sparsity [0.30]*7+[0.75]*5 >> log.txt &
```
...
```python
# selfsupcon_supcon_adapter_vgg_16_bn
...
--arch selfsupcon_supcon_adapter_vgg_16_bn --batch_size 1024 --epochs 1000 --lr_type cos --learning_rate 0.5 --momentum 0.9 --weight_decay 0.0005 --dataset cifar100 --selfsupconlossxs 0.5 --supconlossxs 2.0 --selfsupcontemp 0.5 --supcontemp 0.1

# selfsupcon_supcon_vgg_16_bn
python vgg_selfsupcon_supcon_train_pruned_pipline.py --data_dir ./data --result_dir ./result/vgg-selfsupcon-supcon_scrach_train/selfsupcon_supcon_adapter_vgg_16_bn_cifar100 \
--arch selfsupcon_supcon_vgg_16_bn --batch_size 1024 --epochs 1000 --lr_type cos --learning_rate 0.5 --momentum 0.9 --weight_decay 0.0005 --dataset cifar100 --selfsupconlossxs 0.5 --supconlossxs 2.0 --selfsupcontemp 0.5 --supcontemp 0.1
```
