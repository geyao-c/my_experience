...
def get_model(modelpath):
    ...
    if 'adapter' in modelpath:
        model = adapter21resnet_56([0.]*100, 10, [0.]*100)
    else:
...
if __name__ == '__main__':
    ...
    model1 = get_model('../pretrained_models/94.28_adapter21resnet_56_cifar10.pth.tar')
    ...
    plt.legend()
    plt.savefig('images/image13.png', dpi=600)
    plt.show()
