...
def main():
    ...
    jieduan_ckpt_dir = os.path.join('./pretrained_models', 'vgg-selfsupcon-supcon_scrach_train', now)
    ...
    while epoch < args.epochs:
        ...
        if (epoch + 1) % 5 == 0:
            ...
            fmap_saved_dir = os.path.join("../conv_feature_map", 'vgg-selfsupcon-supcon_scrach_train', now,
            ...
            graf_pruned_83_result_dir = os.path.join('./result/vgg-selfsupcon-supcon_graf_pruned', now,
                                                     str(total_loss) + '_' +
                                                     'cifar100tocifar10' + '_' + args.arch + '_' + 'pruned_83')
            ...
            graf_pruned_83_cmd = "python graf_prune_finetune_cifar_n.py --pretrained_dataset cifar100 --finetune_dataset " \
                                 "cifar10 --finetune_data_dir ./data --pretrained_arch {} --finetune_arch {} " \
                                 ...
                                 "".format(args.arch, args.arch, graf_pruned_83_result_dir, ci_save_dir, jieduan_ckpt_path)
            ...
            graf_pruned_87_result_dir = os.path.join('./result/vgg-selfsupcon-supcon_graf_pruned', now, str(total_loss) + '_' +
                                                     'cifar100tocifar10' + '_' + args.arch + '_' + 'pruned_87')
            ...
            graf_pruned_87_cmd = "python graf_prune_finetune_cifar_n.py --pretrained_dataset cifar100 --finetune_dataset " \
                                 ...
                                 "".format(args.arch, args.arch, graf_pruned_87_result_dir, ci_save_dir, jieduan_ckpt_path)
            ...
            #                                                        jieduan_ckpt_path)
            execute_command([graf_pruned_83_cmd, graf_pruned_87_cmd])
