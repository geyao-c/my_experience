...
def adapter_vgg_16_bn_v4(sparsity, adapter_sparsity = None, num_classes=10, dataset=None):
    return VGG4(sparsity=sparsity, cfg=adapter_cfg_v4, num_classes=num_classes)
