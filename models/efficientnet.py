...
class EfficientNet(nn.Module):
    ...
    def __init__(self, compress_rate, param, num_classes=1000, stem_channels=32, feature_size=1280, drop_connect_rate=0.2):
        ...
        for _, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats in self.config:
...
class EfficientNet_CHANGED(nn.Module):
    config = [
        #(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats)
        [32,  16,  3, 1, 1, 0.25, 1],
        [16,  24,  3, 1, 6, 0.25, 2],
    ...
    def __init__(self, compress_rate, param, num_classes=1000, stem_channels=32, feature_size=1280, drop_connect_rate=0.2):
        super(EfficientNet_CHANGED, self).__init__()
...
class EfficientNet_CHANGED_V2(nn.Module):
    config = [
        #(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats)
        [32,  16,  3, 1, 1, 0.25, 1],
        [16,  24,  3, 1, 6, 0.25, 2],
        ...
        [40,  80,  3, 1, 6, 0.25, 3],
        [80,  112, 5, 2, 6, 0.25, 3],
        [112, 192, 5, 1, 6, 0.25, 4],
        [192, 320, 3, 1, 6, 0.25, 1]
    ]

    def __init__(self, compress_rate, param, num_classes=1000, stem_channels=32, feature_size=1280, drop_connect_rate=0.2):
        super(EfficientNet_CHANGED_V2, self).__init__()
...
class EfficientNet_CHANGED_V3(nn.Module):
    config = [
        #(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats)
        [32,  16,  3, 1, 1, 0.25, 1],
        [16,  24,  3, 1, 6, 0.25, 2],
    ...
    def __init__(self, compress_rate, param, num_classes=1000, stem_channels=32, feature_size=1280, drop_connect_rate=0.2):
        super(EfficientNet_CHANGED_V3, self).__init__()
...
class EfficientNet_CHANGED_V4(nn.Module):
    config = [
        #(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats)
        [32,  16,  3, 1, 1, 0.25, 1],
        [16,  24,  3, 1, 6, 0.25, 2],
        ...
        [40,  80,  3, 1, 6, 0.25, 3],
        [80,  112, 3, 2, 6, 0.25, 3],
        [112, 192, 3, 1, 6, 0.25, 4],
        [192, 320, 3, 1, 6, 0.25, 1]
    ]

    def __init__(self, compress_rate, param, num_classes=1000, stem_channels=32, feature_size=1280, drop_connect_rate=0.2):
        super(EfficientNet_CHANGED_V4, self).__init__()
...
class EfficientNet_CHANGED_V5(nn.Module):
    config = [
        #(in_channels, out_channels, kernel_size, stride, expand_ratio, se_ratio, repeats)
        [32,  16,  3, 1, 1, 0.25, 1],
        [16,  24,  3, 1, 6, 0.25, 2],
        ...
        [40,  80,  3, 1, 6, 0.25, 3],
        [80,  112, 3, 1, 6, 0.25, 3],
        [112, 192, 3, 2, 6, 0.25, 4],
        [192, 320, 3, 1, 6, 0.25, 1]
    ]

    def __init__(self, compress_rate, param, num_classes=1000, stem_channels=32, feature_size=1280, drop_connect_rate=0.2):
        super(EfficientNet_CHANGED_V5, self).__init__()
...
def efficientnet_b0(sparsity, num_classes=10, dataset=None):
    return EfficientNet(sparsity, (1.0, 1.0, 224, 0.2), num_classes=num_classes)

def efficientnet_b0_changed(sparsity, num_classes=10, dataset=None):
    return EfficientNet_CHANGED(sparsity, (1.0, 1.0, 224, 0.2), num_classes=num_classes)

def efficientnet_b0_changed_v2(sparsity, num_classes=10, dataset=None):
    return EfficientNet_CHANGED_V2(sparsity, (1.0, 1.0, 224, 0.2), num_classes=num_classes)

def efficientnet_b0_changed_v3(sparsity, num_classes=10, dataset=None):
    return EfficientNet_CHANGED_V3(sparsity, (1.0, 1.0, 224, 0.2), num_classes=num_classes)

def efficientnet_b0_changed_v4(sparsity, num_classes=10, dataset=None):
    return EfficientNet_CHANGED_V4(sparsity, (1.0, 1.0, 224, 0.2), num_classes=num_classes)
