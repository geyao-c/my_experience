...
# y1 = [92.70, 95.70, 80.90, 78.30, 88.40, 79.00, 94.20, 93.30, 96.40, 93.60]
# y2 = [93.30, 95.70, 80.80, 75.40, 86.70, 79.20, 92.70, 92.60, 96.70, 93.00]

y1 = [87.50, 90.60, 69.70, 68.10, 77.50, 68.10, 86.40, 85.20, 92.70, 88.90]
y2 = [72.30, 81.80, 50.50, 38.90, 48.70, 52.90, 69.30, 75.30, 80.60, 79.10]
...
plt.savefig('image6.jpeg', dpi=600)
plt.show()
